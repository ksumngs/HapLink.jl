...
`Variant`s can be created from the default constructor, a VCF formatted string, or via a row
generated by [`transformbamcounts`](@ref).
...
function Variant(varstring::AbstractString)
    # Split the tab fields
    varfields = split(varstring, "\t")
